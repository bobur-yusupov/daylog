...
class AuthenticationAPITests(APITestCase):
    ...
    def test_register_api_duplicate_email(self) -> None:
        ...
        if response.status_code == status.HTTP_400_BAD_REQUEST:
            ...
            self.assertGreaterEqual(
                users_with_email.count(),
                1,
                "Multiple users with same email created - consider adding email uniqueness validation",
            )
    ...
    def test_register_api_content_type_json(self) -> None:
        ...
        response = self.client.post(
            self.register_url, json.dumps(payload), content_type="application/json"
        )
    ...
    def test_token_authentication_flow(self) -> None:
        ...
        register_response = self.client.post(
            self.register_url, register_payload, format="json"
        )
    ...
    def test_api_error_handling_malformed_json(self) -> None:
        ...
        response = self.client.post(
            self.register_url, malformed_json, content_type="application/json"
        )
...
class AuthenticationSerializerTests(TestCase):
    ...
    def test_user_login_serializer_valid_data(self) -> None:
        ...
        data: Dict[str, Any] = {"username": "testuser", "password": "securepassword123"}
