...
class EmailVerificationModelTests(TestCase):
    ...
    def test_get_valid_otp_expired_code(self):
        ...
        found_verification = EmailVerification.get_valid_otp(self.user, verification.otp_code)
    ...
    def test_model_ordering(self):
        ...
        first_verification = EmailVerification.objects.create(user=self.user)
        ...
        second_verification = EmailVerification.objects.create(user=second_user)
        ...
        self.assertGreaterEqual(all_verifications[0].created_at, all_verifications[1].created_at)
    ...
    def test_user_cascade_deletion(self):
        ...
        self.assertFalse(
            EmailVerification.objects.filter(id=verification_id).exists()
        )
