...
class PasswordResetServiceTests(TestCase):
    ...
    def test_verify_otp_valid_code(self):
        ...
        result = PasswordResetService.verify_otp(self.user.email, password_reset.otp_code)
    ...
    def test_reset_password_with_otp_sends_confirmation_email(self):
        ...
        self.assertEqual(len(mail.outbox), 1)  # Only confirmation (OTP was sent during create_for_user)
