...
class PasswordResetViewsTests(TestCase):
    ...
    def test_password_reset_request_post_invalid_user(self):
        ...
        self.assertEqual(self.client.session['password_reset_email'], 'nonexistent@example.com')
    ...
    def test_password_reset_otp_get_without_session(self):
        ...
        messages = list(get_messages(response.wsgi_request))
        self.assertTrue(any('start the password reset process' in str(msg) for msg in messages))
    ...
    def test_password_reset_otp_post_valid_code(self):
        ...
        self.assertEqual(self.client.session['password_reset_verified_email'], self.user.email)
        self.assertEqual(self.client.session['password_reset_verified_otp'], password_reset.otp_code)
    ...
    def test_authenticated_user_redirected(self):
        ...
        self.assertNotContains(response_with_follow, 'Enter your email to reset your password', status_code=200)
