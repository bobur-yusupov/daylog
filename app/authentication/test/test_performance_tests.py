...
class EmailVerificationPerformanceTests(TestCase):
    ...
    def test_concurrent_email_sending_performance(self, mock_send):
        ...
        self.assertGreaterEqual(len(successful_results), 10, 
                               f"At least 10 of 50 concurrent emails should succeed, got {len(successful_results)}")
        self.assertLess(total_duration, 15.0, "Concurrent email test should complete within reasonable time")
    ...
    def test_memory_usage_during_bulk_operations(self):
        ...
        self.assertLess(memory_per_verification, 0.2, "Memory per verification should be low")
    ...
    def test_stress_registration_flow(self):
        ...
        self.skipTest("SQLite doesn't handle concurrent registration stress testing well")
        start_time = time.time()
        ...
        self.assertEqual(len(successful_registrations), 25, "All registrations should succeed")
        ...
        self.assertLess(max_duration, 5.0, "Even slow registrations should be reasonable")
...
class EmailVerificationLoadTests(TransactionTestCase):
    ...
    def test_concurrent_verification_different_users(self):
        ...
        print(f"Concurrent test: {len(successful_verifications)}/5 successful in {duration:.4f}s")
    ...
    def test_expired_verification_cleanup_performance(self):
        ...
        print(f"Cleaned up {deleted_count} expired verifications in {duration:.4f} seconds")
...
class EmailVerificationScalabilityTests(TestCase):
    ...
    def test_concurrent_resend_requests(self):
        ...
        self.assertGreater(len(successful_resends), 0, "At least some resends should succeed")
        ...
        self.assertGreaterEqual(active_verifications, 1, "Should have at least one active verification")
