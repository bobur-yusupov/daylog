...
PASSWORD_RESET_CONFIRMATION_EMAIL_ENABLED = os.getenv("PASSWORD_RESET_CONFIRMATION_EMAIL_ENABLED", "True") == "True"
PASSWORD_RESET_SECURITY_ALERTS_ENABLED = os.getenv("PASSWORD_RESET_SECURITY_ALERTS_ENABLED", "True") == "True"
